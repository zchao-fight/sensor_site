...
public class ResponseCodeConst {
    ...
    static {
        ...
        // 部门业务 ,10001 - 10100
        ResponseCodeContainer.register(SensorResponseCodeConst.class, 101, 200);

    }

    public static final ResponseCodeConst SUCCESS = new ResponseCodeConst(1, "success", true);

    public static final ResponseCodeConst ERROR_PARAM = new ResponseCodeConst(11, "参数异常！");
    public static final ResponseCodeConst ERROR_PARAM_ANY = new ResponseCodeConst(12, "%s参数异常！");
    public static final ResponseCodeConst SYSTEM_ERROR = new ResponseCodeConst(13, "系统错误");

    public static final ResponseCodeConst DEVELOPMENT = new ResponseCodeConst(14, "此功能正在开发中");

    public static final ResponseCodeConst NOT_EXISTS = new ResponseCodeConst(15, "数据不存在");
    ...
    private static class ResponseCodeContainer {
        ...
        public static void put(ResponseCodeConst codeConst) {
            ...
            if(RESPONSE_CODE_MAP.keySet().contains(code)){
                LOG.error(String.format("<ResponseDTO> Id(%d) out of range[%d,%d], " + "class:%s  code is repeat!", code, idRange[0],
                        idRange[1], codeConst.getClass().getSimpleName()));
                System.exit(0);
            }
