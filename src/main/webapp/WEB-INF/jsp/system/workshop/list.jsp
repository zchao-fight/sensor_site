                    ...
                    <table class="table table-bordered table-striped table-hover" id="sysUser">
                        ...
                        <c:forEach items="${workshops}" var="workshop">
                            <tr>
                                ...
                                <td>${workshop.ip}</td>
                                <td>
                                    <button class="btn btn-primary btn-xs" onclick="editWorkshop('${workshop.id}')">编辑</button>
                                    <button class="btn btn-danger btn-xs" onclick="deleteWorkshop('${workshop.id}')">删除</button>
                                    <button class="btn btn-danger btn-xs" onclick="clearCount('${workshop.workshopNumber}')">清零</button>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
...
<script>
  ...
  function deleteWorkshop(id) {
      ...
      $.ajax({
          type : "post",
          url : "${ctx}/workshop/deleteWorkshop.action",
          dataType : "json",
          data : {
              id : id
          },
