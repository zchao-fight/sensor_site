...
ol.control.MeasureTool = function (opt_options) {
    ...
    html += '<li><input type="button" value="测距"></li>';
    html += '<li><input type="button" value="测面"></li>';
     ...
     * @function 绑定测距 测面
     */
    $('#measureLength').click(function (e) {
        this_.mapmeasure('length');
        console.log(e);
    });

    $('#measureArea').click(function (e) {
        this_.mapmeasure('area');
        console.log(e);
    });
...
ol.control.MeasureTool.prototype.mapmeasure = function (typeSelect) {
    ...
    popupcloser.onclick = function (e) {
        ...
        var popArray = map.getOverlays().getArray();
        for (var i in popArray){
            popArray[i].setPosition(undefined);
        }
